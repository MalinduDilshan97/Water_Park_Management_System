 ...
 * @author SL_WOLF
 */
public class User_Remove extends javax.swing.JPanel implements Observer{

    /**
     * Creates new form User_Remove
     */
    ...
    public User_Remove() {
        ...
        try {
            ...
            Logger.getLogger(User_Remove.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        lblBoxHeader.setText("     Remove User");
    ...
    private void lblRemoveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRemoveMouseClicked
         try {
            boolean result = ManageUserController.deleteUser(txtId.getText());

            if (result) {
                JOptionPane.showMessageDialog(this, "User has been deleted successfully");
            } else {
                JOptionPane.showMessageDialog(this, "User can't be deleted");
            }
            ...
            JOptionPane.showMessageDialog(this, "User can't be deleted", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void txtIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIdActionPerformed
        ...
        try {
                    ...
                    if (reserveCategory) {
                        ...
                        update = false;
                        JOptionPane.showMessageDialog(User_Remove.this, "Item has been already reserved");
                    }
