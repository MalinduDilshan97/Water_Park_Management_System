...
import edu.ijse.water.controller.ManageCustomerController;
 ...
 * @author SL_WOLF
 */
public class Customer_Report extends javax.swing.JPanel implements Observer{
    ...
    private void initComponents() {
        ...
        lblDate.setText("Total Daily Visitors                            :");
        add(lblDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 460, 200, 20));
        ...
        tblCustomers.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer Id", "Wrist Band Id", "Entrance Time"
            }
        ) {
        ...
        add(dChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, 200, -1));
    ...
    private void lblPrintMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblPrintMouseClicked
        ...
        try {
            JasperReport compiledReport = (JasperReport) JRLoader.loadObject(Customer_Report.class.getResource("/edu/ijse/water/jasper/Customer.jasper"));
            
            HashMap<String, Object> parameters = new HashMap<>();
            parameters.put("Date", day);
            parameters.put("Total", txtTotal.getText());
            JasperPrint filledReport= JasperFillManager.fillReport(compiledReport, parameters, new JRTableModelDataSource(tblCustomers.getModel()));
    ...
    private void lblSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSearchMouseClicked
        ...
        try {
            List<CustomerDTO> customerDTOs = ManageCustomerController.getCustomerByDate(day);
